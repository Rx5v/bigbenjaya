...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="<?= base_url('assets/template/adminlte/') ?>plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?= base_url('assets/template/adminlte/') ?>plugins/raphael/raphael.min.js"></script>
<script src="<?= base_url('assets/template/adminlte/') ?>plugins/jquery-mapael/jquery.mapael.min.js"></script>
...
<script src="<?= base_url('assets/template/adminlte/') ?>dist/js/pages/dashboard2.js"></script>
</body>
